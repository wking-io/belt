...
export class BackendPatternError extends Schema.TaggedErrorClass<BackendPatternError>()(
  "BackendPatternError",
  {
...
export class BackendPattern extends Context.Service<BackendPattern, BackendPatternService>()(
  "belt/BackendPattern",
) {
