...
import type { WorktreeDestinationResolver } from "@repo/tool-iterations-provider-worktrees";
...
export function portlessResolver(options: PortlessResolverOptions): WorktreeDestinationResolver {
